...
% --- Noise Parameters ---
a_noise = 1e-6;
D_comp = a_noise * eye(n_total); % Process noise coupling
E_comp = a_noise * eye(p_total); % Measurement noise coupling
...
title('Luenberger Observer Estimates ($\hat{y}$)', 'Interpreter', 'latex', 'Color', 'w');
xlabel('k', 'Color', 'w');
